...
def display_toppings(toppings_list):
...
while True:
    ...
    if user_choice.lower() == 'a':
        ...
        display_toppings(pizza_toppings)
        if pizza_toppings:
        ...
        if pizza_toppings:
            display_available_toppings()
            old_topping = input("Enter the topping to be changed: ")
            if old_topping.capitalize() in pizza_toppings:
                new_topping = input("Enter the new topping: ")
                pizza_toppings[pizza_toppings.index(old_topping.capitalize())] = new_topping.capitalize()
                print(f"{old_topping.capitalize()} has been replaced with {new_topping.capitalize()}.")
            else:
                print("Sorry, you don't have that topping on your pizza.")
        else:
            print("Your pizza is empty. Please add toppings before changing.")
